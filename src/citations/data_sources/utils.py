...
def get_author_ids(
    ...
    List[Dict[str, Optional[str]]]
        A list of dictionaries, where each dictionary represents an author and their associated information. The dictionary contains the following keys:
            - "orcidid" : str, optional
                The ORCID ID of the author.
            - "google_scholar_id" : str, optional
                The Google Scholar ID of the author.
